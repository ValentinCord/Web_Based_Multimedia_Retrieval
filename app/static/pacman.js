...
function () {
    ...
    g.prepareElement = function (b, c, d) {
        ...
        if (g.useCss) {
            b.style.backgroundImage = "url(../static/pacman10-hp-sprite-2.png)";
            b.style.backgroundPosition = -c + "px " + -d + "px";
            b.style.backgroundRepeat = "no-repeat"
        } else {
            b.style.overflow = "hidden";
            c = "display: block; position: relative; left: " + -c + "px; top: " + -d + "px";
            b.innerHTML = '<img style="' + c + '" src="../static/pacman10-hp-sprite.png">'
        }
    };
    ...
    g.handleTouchMove = function (b) {
        if (b.touches.length > 1) g.cancelTouch();
            ...
            g.touchDX = w.touches[0].pageX - g.touchStartX;
    ...
    g.createKillScreenElement = function (b, c, d, f, h) {
        ...
        j.style.zIndex = 119;
        if (h) {
            j.style.background = "url(../static/pacman10-hp-sprite.png) -" + g.killScreenTileX + "px -" + g.killScreenTileY + "px no-repeat";
            g.killScreenTileY += 8
    ...
    g.prepareGraphics = function () {
        g.graphicsReady = e;
        g.preloadImage("../static/pacman10-hp-sprite.png")
    };
